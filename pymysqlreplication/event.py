...
class BinLogEvent(object):
    def __init__(self, from_packet, event_size, table_map, ctl_connection,
                 ...
                 ignore_decode_errors=False, calculate_crc=False):
        ...
        self.complete = True
        self._calculate_crc = calculate_crc
    ...
    def __validate_event(self):
        ...
        if byte_data == footer:
            ...
            logging.error('An CRC32 has failed for the event type %s, '
...
class MariadbGtidEvent(BinLogEvent):
    ...
    def __init__(self, from_packet, event_size, table_map, ctl_connection, **kwargs):
        ...
        # super(MariadbGtidEvent, self)._crc32()
